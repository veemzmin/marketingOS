...
export function SecuritySettingsClient() {
  const [setupState, setSetupState] = useState<
    "idle" | "loading" | "qr" | "verifying" | "success"
  >("idle")
              ...
              <div className="mt-6 space-y-6">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    ...
                    authenticator app to scan this QR code:
                  </p>
              ...
              <div className="mt-6">
                <div className="rounded-md bg-green-50 p-4">
                  <p className="text-sm text-green-800">
                    2FA has been successfully enabled for your account! You&apos;ll
                    now need to enter a code from your authenticator app when signing
                    in.
                  </p>
                </div>
              </div>
